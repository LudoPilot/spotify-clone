      ...
      >
        <div class="flex items-center">
          <img
              class="rounded-full"
              width="27"
              src="https://yt3.ggpht.com/yti/AOXPAcUyyIh4Yp9-cViQ71oXPoh1hepOPAqK1ngsOl9O=s88-c-k-c0x00ffffff-no-rj"
          >
        </div>
        <div class="text-white text-[14px] ml-1.5 font-semibold">Ludo Dev</div>
    ...
    >
      ...
      <ul>
        ...
        <RouterLink to="./search">
          <MenuItem class=ml-[1px] :icon-size="23" name="Search" iconString="search" pageUrl="/search" />
        </RouterLink>
        <RouterLink to="./library">
          <MenuItem class=ml-[2px] :icon-size="23" name="Library" iconString="library" pageUrl="/library" />
        </RouterLink>
        <div class="py-3.5"></div>
        <MenuItem :icon-size="24" name="Create playlist" iconString="playlist" pageUrl="/playlist" />
        <MenuItem class=ml-[1px] :icon-size="27" name="Liked songs" iconString="liked" pageUrl="/liked" />
      </ul>
